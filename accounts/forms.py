...
class UserProfileForm(forms.ModelForm):
    #  Using of custom validator use FileField Insted ImageField
    ...
    # #  Make Lat and Long ReadOnly
    # latitude  = forms.CharField(widget=forms.TextInput(attrs={'readonly':'readonly'}))
    # longitude  = forms.CharField(widget=forms.TextInput(attrs={'readonly':'readonly'}))
    
    class Meta:
        model = UserProfile
        fields = ['profile_picture', 'cover_photo', 'address', 'country', 'province', 'city', 'pin_code', 'latitude', 'longitude']

    #  Other Way to ReadOnly Lat and Long
